...
import callicon from "../../../Assets/social icons/call.png"
import message from "../../../Assets/social icons/message.png"
                            ...
                            <ul className=" dark:text-gray-400 font-medium">
                                <li className="mb-4 flex gap-2  items-center" >
                                   <img className="w-5 h-5" src={location} alt="" />
                                    ...
                                    <a href="https://flowbite.com/" className="hover:underline">4005, Silver business point India</a>
                                </li>
                                ...
                                <li className="flex gap-5"> 
                                    ...
                                    <a href="https://tailwindcss.com/" className="hover:underline">123 456 789</a>
                                </li>
                                <li className="flex gap-5 pt-5"> 

                                    <img className="w-5 h-5" src={message} alt="" />

                                    <a href="https://tailwindcss.com/" className="hover:underline">contact@matico.com</a>
                                </li>
                            </ul>
                        </div>
                        <div>
...
Best Sales */}
                                ...
                                <li className="pt-2">
                                    <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Best Sales</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Matico</a>. All Rights Reserved.
                    </span>
