...
<div className="grid mb-8 border container mx-auto border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">ToyZone Delivers Excellence: A Customer's Perspective</h3>
            <p className="my-5">ToyZone surpassed my expectations with their impeccable service and exceptional toy car collection. From the user-friendly website to the prompt delivery, every aspect of my purchase was seamless. The quality and attention to detail in their toy cars left me in awe. ToyZone is my go-to destination for an unforgettable toy car experience.</p>
        </blockquote>
    ...
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">Unforgettable Toy Car Adventure: A Customer's Journey with ToyZone</h3>
            <p className="my-4">My adventure with ToyZone was nothing short of amazing. Their extensive selection of toy cars catered to my every desire, and the smooth purchasing process made it a breeze to bring them into my collection. The quality and craftsmanship of their toy cars surpassed my expectations, transporting me to a world of joy and nostalgia.</p>
        </blockquote>
        <figcaption className="flex items-center justify-center space-x-3">
    ...
    <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
        <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white">Unmatched Toy Shopping Experience at ToyJoy</h3>
