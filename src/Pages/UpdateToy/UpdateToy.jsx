...
const AddAToy = () => {
  ...
  <input type="submit" className="text-2xl bg-gradient-to-r from-blue-500 via-purple-500 to-pink-400 py-8 text-center text-white block w-full"  value="Update This Product" />
